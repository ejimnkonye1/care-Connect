  ...
  return(
    ...
    <form className="md:max-w-md w-full mx-auto" onSubmit={handleLogin}>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
        ...
        <div>
          <a href="resetstaff" className="text-blue-600 font-semibold text-sm hover:underline">
            Forgot Password?
          </a>
        </div>
      </div>
      ...
      <button
        ...
        <p className="text-gray-800 text-sm text-center mt-6">
          Don't have an account <a href="/signup" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a>
        </p>
      </div>
    </form>
