        ...
        <nav className="flex items-center z-10 text-black">
            ...
            >
                <li className={`${menuOpen? 'mb-2':''}`}>
                    <a href="#home" className="text-black text-base font-semibold px-8 py-2 transition-colors duration-200 hover:text-gray-300">Home</a>
                </li>
                <li className={`${menuOpen? 'mb-2':''} `} >
                    <a href="#Our mission" className=" text-base font-semibold px-8 py-2 transition-colors duration-200 hover:text-gray-300">Our Mission</a>
                </li>
                <li className={`${menuOpen? 'mb-3':''}`}>
                    <a href="#testimonials" className=" text-base font-semibold px-8 py-2 transition-colors duration-200 hover:text-gray-300">Testimonials</a>
                </li>
                <li className={`${menuOpen? 'mb-3':''}`}>
                    <a href="#pricing" className="text-base font-semibold px-8 py-2 transition-colors duration-200 hover:text-gray-300">Pricing</a>
                </li>
                <li className={`${menuOpen? 'mb-3':''}`}>
                    <a 
                     onClick={HandleLogin}
